...
import { headers, QUESTIONS_TABLE_NAME, REST_API_URL, SESSIONS_TABLE_NAME } from "../shared";
import { ISession } from "./interfaces";

const MIN_SESSION_ID = 10000000;
const MAX_SESSION_ID = 99999999;

export const fetchSessionById = async (sessionId: string): Promise<ISession | null> => {
...
export const addSession = async (newSession: Omit<ISession, "id">) => {
	const newSessionId = calcNewSessionId(MIN_SESSION_ID, MAX_SESSION_ID);
